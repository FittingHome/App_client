...
<body>
  ...
  <div id="screen-size" class="screen-size">
    <span id="screen-expand" onclick="resizeNav();"><svg width="30" height="30" viewBox="0 0 448 512">
        <path fill="currentColor" d="M32 32C14.3 32 0 46.3 0 64v96c0 17.7 14.3 32 32 32s32-14.3 32-32V96h64c17.7 0 32-14.3 32-32s-14.3-32-32-32H32zm32 320c0-17.7-14.3-32-32-32S0 334.3 0 352v96c0 17.7 14.3 32 32 32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32H64v-64zM320 32c-17.7 0-32 14.3-32 32s14.3 32 32 32h64v64c0 17.7 14.3 32 32 32s32-14.3 32-32V64c0-17.7-14.3-32-32-32h-96zm128 320c0-17.7-14.3-32-32-32s-32 14.3-32 32v64h-64c-17.7 0-32 14.3-32 32s14.3 32 32 32h96c17.7 0 32-14.3 32-32v-96z" />
      </svg></span>
    <span id="screen-compress" hidden onclick="resizeNav();"><svg width="30" height="30" viewBox="0 0 448 512">
        <path fill="currentColor" d="M160 64c0-17.7-14.3-32-32-32S96 46.3 96 64v64H32c-17.7 0-32 14.3-32 32s14.3 32 32 32h96c17.7 0 32-14.3 32-32V64zM32 320c-17.7 0-32 14.3-32 32s14.3 32 32 32h64v64c0 17.7 14.3 32 32 32s32-14.3 32-32v-96c0-17.7-14.3-32-32-32H32zM352 64c0-17.7-14.3-32-32-32s-32 14.3-32 32v96c0 17.7 14.3 32 32 32h96c17.7 0 32-14.3 32-32s-14.3-32-32-32h-64V64zm-32 256c-17.7 0-32 14.3-32 32v96c0 17.7 14.3 32 32 32s32-14.3 32-32v-64h64c17.7 0 32-14.3 32-32s-14.3-32-32-32h-96z" />
      </svg></span>
  </div>

  <div id="sidebar-details" class="sidebar-right">
    <div class="pill-nav">
      <a class="<?php if ($selectedItem == "top") {
                  echo ("active");
                } ?>" href="index.php?item=top"><svg width="40" height="32" viewBox="0 0 640 512">
      ...
      <a class="<?php if ($selectedItem == "down") {
                  echo ("active");
                } ?>" href="index.php?item=down"><svg width="25" height="25" viewBox="0 0 512 512">
      ...
      <a class="<?php if ($selectedItem == "head") {
                  echo ("active");
                } ?>" href="index.php?item=head"><svg width="25" height="25" viewBox="0 0 640 512">
      ...
      <a class="<?php if ($selectedItem == "feet") {
                  echo ("active");
                } ?>" href="index.php?item=feet"><svg width="25" height="25" viewBox="0 0 640 512">
  ...
  <div class="sidebar-nav">
    ...
    <div class="sidebar-nav-bottom">
      <div class="dropdown">
        <a href="account.php"><svg width="50" height="50" viewBox="0 0 448 512">
            <path fill="currentColor" d="M224 256c70.7 0 128-57.3 128-128S294.7 0 224 0S96 57.3 96 128s57.3 128 128 128zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512h388.6c16.4 0 29.7-13.3 29.7-29.7c0-98.5-79.8-178.3-178.3-178.3h-91.4z" />
          </svg>
        </a>
    ...
    <div id="myLinks" class="menu">
      ...
      <a onclick="remove()"><svg width="32" height="32" viewBox="0 0 512 512">
          <path fill="currentColor" d="M288 32c0-17.7-14.3-32-32-32s-32 14.3-32 32v224c0 17.7 14.3 32 32 32s32-14.3 32-32V32zm-144.5 88.6c13.6-11.3 15.4-31.5 4.1-45.1s-31.5-15.4-45.1-4.1C49.7 115.4 16 181.8 16 256c0 132.5 107.5 240 240 240s240-107.5 240-240c0-74.2-33.8-140.6-86.6-184.6c-13.6-11.3-33.8-9.4-45.1 4.1s-9.4 33.8 4.1 45.1c38.9 32.3 63.5 81 63.5 135.4c0 97.2-78.8 176-176 176s-176-78.8-176-176c0-54.4 24.7-103.1 63.5-135.4z" />
        </svg></a>
    </div>
  ...
  <div class="bar-button-bottom">
    <button onclick="moveSidebarLeft()"><svg width="40" height="32" viewBox="0 0 640 512">
        <path fill="currentColor" d="M211.8 0c7.8 0 14.3 5.7 16.7 13.2C240.8 51.9 277.1 80 320 80s79.2-28.1 91.5-66.8C413.9 5.7 420.4 0 428.2 0h12.6c22.5 0 44.2 7.9 61.5 22.3l126.2 105.1c6.6 5.5 10.7 13.5 11.4 22.1s-2.1 17.1-7.8 23.6l-56 64c-11.4 13.1-31.2 14.6-44.6 3.5L480 197.7V448c0 35.3-28.7 64-64 64H224c-35.3 0-64-28.7-64-64V197.7l-51.5 42.9c-13.3 11.1-33.1 9.6-44.6-3.5l-56-64c-5.7-6.5-8.5-15-7.8-23.6s4.8-16.6 11.4-22.1L137.7 22.3C155 7.9 176.7 0 199.2 0h12.6z" />
      </svg></button>
    <button onclick="location.href='ARView.php'">AR</button>
    <button onclick="moveSidebarRight()"><svg width="32" height="32" viewBox="0 0 512 512">
