...
[
  {
    "id": "index.php?topGarmentName=Henry_Tshirt",
    "name": "T-shirt",
    "pathImg": "resources/images/Tshirt.png",
    "price": "$19.99"
  },
  {
    "id": "index.php?downGarmentName=Henry_Pants",
    "name": "Pant",
    "pathImg": "resources/images/Pants.png",
    "price": "$19.99"
  },
  {
    "id": "index.php?topGarmentName=Henry_Male_Hoody",
    "name": "Hoody",
    "pathImg": "resources/images/Male_Hoody.png",
    "price": "$19.99"
  },
  {
    "id": "index.php?topGarmentName=Henry_Garments1_Hana",
    "name": "Crop Top",
    "pathImg": "resources/images/Garments1_Hana.png",
    "price": "$19.99"
  },
  {
    "id": "index.php?topGarmentName=Henry_Female_HalterneckDress",
    "name": "Dress",
...
<body>
    ...
    <div class="col-12">
      ...
      ?>
        <li>
          <div class="col-12">
            <div class="card">
              <button onclick='location.href="<?php echo($favorite["id"]) ?>"'>
  ...
  <div id="sidebar-details" class="sidebar-right">
    <div class="pill-nav">
      <a class="active" href=""><svg width="40" height="32" viewBox="0 0 640 512">
          <path fill="currentColor"
      ...
      <a href=""><svg width="25" height="25" viewBox="0 0 512 512">
          <path fill="currentColor"
      ...
      <a href=""><svg width="25" height="25" viewBox="0 0 640 512">
          <path fill="currentColor"
    ...
    <div class="row">
      ...
      <?php
      if (isset($_REQUEST["topGarmentName"])) {
        ?>
        <button onclick='location.href="index.php?topGarmentName=Henry_hoodie_S"' class="col-4 button-size-active">S</button>
        <button onclick='location.href="index.php?topGarmentName=Henry_Male_Hoody"' class="col-4 button-size">M</button>
        <button onclick='location.href="index.php?topGarmentName=Henry_hoodie_L"' class="col-4 button-size">L</button>
        <!-- <button class="col-4 button-size">XL</button> -->
        <!-- <button class="col-4 button-size">XXL</button> -->
      <?php
      }
      else if (isset($_REQUEST["downGarmentName"])) {
        ?>
        <button onclick='location.href="index.php?downGarmentName=Henry_pants_L"' class="col-4 button-size-active">S</button>
        <button onclick='location.href="index.php?downGarmentName=Henry_pants_S"' class="col-4 button-size">M</button>
        <button onclick='location.href="index.php?downGarmentName=Henry_Pants"' class="col-4 button-size">L</button>
        <?php
      }
      ?>
      </div>
    ...
    <div class="row">
      <div class="col-12" style="text-align: center;">
        <button class="btn btn-default border-button" onclick="removeGarments();">Effacer</button>
      </div>
    </div>
  </div>
