...
<body>
  ...
  <div id="myFilter" class="row sidebar-filtre">
  ...
  <div class="sidebar-nav responsive">
  ...
  <script>
    ...
    if ("<?php echo($_REQUEST["type"]) ?>" == "top") {
      localStorage.setItem('topGarmentName', name + "<?php echo('_' . $_REQUEST["garment"] . '_S') ?>");
    }
    if ("<?php echo($_REQUEST["type"]) ?>" == "down") {
      localStorage.setItem('downGarmentName', name + "<?php echo('_' . $_REQUEST["garment"] . '_S') ?>");
    }
